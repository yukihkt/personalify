  ...
  <div class="d-flex justify-content-center vh-75 align-items-center">
    <div class="row" id="main-area">
      ...
      >
        <div>
          <transition name="fade">
            <div class="d-flex justify-content-start" v-if="enterTop">
              {{ messages[0] }}
            </div>
          </transition>
        </div>
        <div>
          <transition name="fade">
            <div class="d-flex justify-content-center" v-if="enterMid">
              {{ messages[1] }}
            </div>
          </transition>
        </div>
        <div>
          <transition name="fade">
            <div class="d-flex justify-content-start" v-if="enterBottom">
              {{ messages[2] }}
            </div>
          </transition>
        </div>
